package data.structures._9_tree.avl;
...
public class AvlTreeDemo {
    public static void main(String[] args) {
        ...
        tree.infixOrder();
        System.out.println("树高度：" + tree.getRoot().height());   // 4
        System.out.println("左树高度：" + tree.getRoot().leftHeight());  // 1
        System.out.println("右树高度：" + tree.getRoot().rightHeight()); // 3
