...
![img](image/数据结构与算法_韩顺平/o_200731022403批注 2020-07-31 102303-1670135040095-6.png)
...
![img](image/数据结构与算法_韩顺平/o_200731022412批注 2020-07-31 102319-1670135040094-5.png)
...
3. 示意图： (使用数组模拟队列示意图)
   ...
   ![img](image/数据结构与算法_韩顺平/o_200731065541批注 2020-07-31 145520-1670135040095-7.png)
...
![数组模拟队列，环形队列_韩顺平听课笔记_环形队列_10](image/数据结构与算法_韩顺平/fsddsd-1670135040095-9.png)
...
![image-20220525224146916](image/数据结构与算法_韩顺平/image-20220525224146916.png)
...
![img](image/数据结构与算法_韩顺平/o_200802102959批注 2020-08-02 182916-1670135040095-10.png)
...
![img](image/数据结构与算法_韩顺平/o_200802103008批注 2020-08-02 182932-1670135040095-8.png)
...
![image-20220609233310066](image/数据结构与算法_韩顺平/image-20220609233310066-1670135040095-11.png)
...
![image-20200715223005566](image/数据结构与算法_韩顺平/image-20200715223005566.610aef49-1670135040095-12.png)

![image-20200715223033152](image/数据结构与算法_韩顺平/image-20200715223033152.d7e82b07.png)
...
![img](image/数据结构与算法_韩顺平/o_200804035054图片12.jpg)
...
![image-20200717225215349](image/数据结构与算法_韩顺平/image-20200717225215349.a45f9eda-1670135040095-13.png)
...
![img](image/数据结构与算法_韩顺平/o_200812124506批注 2020-08-12 204424-1670135040095-14.png)
...
![image-20220621222353803](image/数据结构与算法_韩顺平/image-20220621222353803.png)
...
![img](image/数据结构与算法_韩顺平/o_200815031710批注 2020-08-15 111646-1670135040095-16.png)
...
![img](image/数据结构与算法_韩顺平/o_200815105238图片1-1670135040095-15.png)
...
![img](image/数据结构与算法_韩顺平/o_200815114208图片2-1670135040095-17.png)
...
![image-20220628235527238](image/数据结构与算法_韩顺平/image-20220628235527238-1670135040095-18.png)

![image-20220628235544023](image/数据结构与算法_韩顺平/image-20220628235544023-1670135040095-19.png)

![image-20220628235615237](image/数据结构与算法_韩顺平/image-20220628235615237-1670135040095-20.png)
...
![img](image/数据结构与算法_韩顺平/o_200815115841图片3.png)
...
1. 常数阶 O(1)
   ...
   ![image-20220629010820599](image/数据结构与算法_韩顺平/image-20220629010820599-1670135040095-21.png)

2. 对数阶 O(log2n)
   ![image-20220629010837905](image/数据结构与算法_韩顺平/image-20220629010837905-1670135040095-22.png)

3. 线性阶 O(n)
   ![image-20220629010858891](image/数据结构与算法_韩顺平/image-20220629010858891.png)

4. 线性对数阶 O(nlog2n)
   ![image-20220629010911807](image/数据结构与算法_韩顺平/image-20220629010911807.png)

5. 平方阶 O(n^2)
   ![image-20220629010927101](image/数据结构与算法_韩顺平/image-20220629010927101-1670135040096-23.png)
...
![img](image/数据结构与算法_韩顺平/o_200815120121图片4-1670135040096-24.png)
...
![img](image/数据结构与算法_韩顺平/o_200816012845图片5.png)
...
![img](image/数据结构与算法_韩顺平/o_200816034537图片6.jpg)
...
![img](image/数据结构与算法_韩顺平/o_200816084239图片7.jpg)
...
![img](image/数据结构与算法_韩顺平/o_200816121446批注 2020-08-16 201429-1670135040096-25.png)
...
![img](image/数据结构与算法_韩顺平/o_200820013839图片3.jpg)
...
>  * nums[l]左侧都小于nums[l]，nums[l]右侧都大于nums[l] ,然后递归即可
>
> ![image-20220710223150710](image/数据结构与算法_韩顺平/image-20220710223150710-1670135040096-27.png)
...
![img](image/数据结构与算法_韩顺平/o_200826025351图片1-1670135040096-29.png)
...
![image-20220703144145315](image/数据结构与算法_韩顺平/image-20220703144145315-1670135040096-28.png)
...
![image-20220703174634250](image/数据结构与算法_韩顺平/image-20220703174634250-1670135040096-26.png)

![image-20220703174649550](image/数据结构与算法_韩顺平/image-20220703174649550-1670135040096-31.png)

![image-20220703174701062](image/数据结构与算法_韩顺平/image-20220703174701062-1670135040096-33.png)
...
![img](image/数据结构与算法_韩顺平/o_200826102106图片4-1670135040096-30.png)
...
3. 将折半查找中的求 mid 索引的公式 , low 表示左边索引 left, high 表示右边索引 right.
   ...
   ![img](image/数据结构与算法_韩顺平/o_200827110206微信截图_20200827190152.png)
...
![img](image/数据结构与算法_韩顺平/o_200827111008图片5.png)
...
![img](image/数据结构与算法_韩顺平/o_200827114213图片6.png)
...
![img](image/数据结构与算法_韩顺平/o_200827115721图片7.png)
...
- 二叉树的子节点分为 **左节点** 和 **右节点**
  ...
  ![image-20201116151129752](image/数据结构与算法_韩顺平/image-20201116151129752.2d1490b6-1670135040096-32.png)

- 如果该二叉树的所有 **叶子节点** 都在 **最后一层**，并且 **节点总数 =** 2n-1 （n 为层数），则我们称为 **满二叉树**

  ![image-20201116151616119](image/数据结构与算法_韩顺平/image-20201116151616119.b0856543-1670135040096-34.png)

- 如果该二叉树的所有叶子节点都在最 **后一层或倒数第二层**，而且 **最后一层的叶子节点在左边连续**，**倒数第二层的叶子节点在右边连续**，我们称为 **完全二叉树**

  ![image-20201116151828693](image/数据结构与算法_韩顺平/image-20201116151828693.5f9c3d69-1670135040096-36.png)
...
![image-20201116152811909](image/数据结构与算法_韩顺平/image-20201116152811909.2516f1d3-1670135040096-35.png)
...
![img](image/数据结构与算法_韩顺平/o_200828061909微信截图_20200828141858.png)
...
![image-20201116163114510](image/数据结构与算法_韩顺平/image-20201116163114510.8a97540e-1670135040096-38.png)
...
![image-20201129163427823](image/数据结构与算法_韩顺平/image-20201129163427823.6a261a22-1670135040096-37.png)
...
![img](image/数据结构与算法_韩顺平/webp.webp)
...
![img](image/数据结构与算法_韩顺平/webp-1670135603373-3.webp)
...
![img](image/数据结构与算法_韩顺平/webp-1670135627873-6.webp)
...
![img](image/数据结构与算法_韩顺平/webp-1670135651897-9.webp)
...
![img](image/数据结构与算法_韩顺平/webp-1670135667893-12.webp)
...
![img](image/数据结构与算法_韩顺平/o_200828072720图片8.png)
...
![img](image/数据结构与算法_韩顺平/o_200828075130微信截图_20200828155120.png)
...
![image-20201202225302702](image/数据结构与算法_韩顺平/image-20201202225302702.8c95a6d4-16582381745323.png)
...
![image-20201202225302702](image/数据结构与算法_韩顺平/image-20201202225302702.8c95a6d4.png)
...
![img](image/数据结构与算法_韩顺平/o_200828080908图1.png)
...
- 确定前一个节点 pre
  ...
  ![image-20201202230643686](image/数据结构与算法_韩顺平/image-20201202230643686.f3691332.png)
...
![image-20201202230643686](image/数据结构与算法_韩顺平/image-20201202230643686.f3691332-16581608948105.png)
...
![image-20201206220455853](image/数据结构与算法_韩顺平/image-20201206220455853.ea7b0cd6.png)

对堆中的节点按层进行编号，映射到数组中如下图

![image-20201206220557693](image/数据结构与算法_韩顺平/image-20201206220557693.583d6ae8.png)
...
![image-20201206220902251](image/数据结构与算法_韩顺平/image-20201206220902251.e01d9c82.png)
...
![image-20201206222442413](image/数据结构与算法_韩顺平/image-20201206222442413.5b760741.png)
...
![image-20201206222914140](image/数据结构与算法_韩顺平/image-20201206222914140.202f9def-1670135040096-39.png)

1. 找到第二个非叶子节点 4，由于 `[4,9,8]` 中，9 元素最大，则 4 和 9 进行交换

   ![image-20201206223207361](image/数据结构与算法_韩顺平/image-20201206223207361.ba4f6e75-1670135040096-41.png)

2. 此时，交换导致了子根 `[4,5,6]` 结构混乱，将其继续调整。`[4,5,6]` 中 6 最大，将 4 与 6 进行调整。

   ![image-20201206223333533](image/数据结构与算法_韩顺平/image-20201206223333533.608f1d62-1670135040096-40.png)
...
1. 将堆顶元素 9 和末尾元素 4 进行交换
   ...
   ![image-20201206223617296](image/数据结构与算法_韩顺平/image-20201206223617296.e756160b-1670135040096-42.png)

2. 重新调整结构，使其继续满足堆定义

   ![image-20201206223650661](image/数据结构与算法_韩顺平/image-20201206223650661.cddf4a8a-1670135040096-43.png)

3. 再将堆顶元素 8 与末尾元素 5 进行交换，得到第二大元素 8

   ![image-20201206223852022](image/数据结构与算法_韩顺平/image-20201206223852022.eeea349c-1670135040096-44.png)

4. 后续过程，继续进行调整、交换，如此反复进行，最终使得整个序列有序

   ![image-20201206223932290](image/数据结构与算法_韩顺平/image-20201206223932290.03af2c98-1670135040096-46.png)
...
![image-20201212161501335](image/数据结构与算法_韩顺平/image-20201212161501335.f1a13430-1670135040096-45.png)
...
3. 组成一颗新的二叉树，该二叉树的根节点权值是，这两颗树的权值之和，如下图：
   ...
   ![image-20201212163112945](image/数据结构与算法_韩顺平/image-20201212163112945.7f485921.png)

4. 再将这颗新的二叉树，以 **根节点的权值大小**，再次排序[4,6,7,8,13,29]，并不断重复上述步骤

   ![image-20201212163237572](image/数据结构与算法_韩顺平/image-20201212163237572.b51a6016.png)

如图所示：将剩余未处理的节点，与新的根节点权值进行排序，那么再次取最小的两棵树 `4 和 6`，组成新的根节点 `10`

![image-20220719235705806](image/数据结构与算法_韩顺平/image-20220719235705806.png)

上一步处理完后排序[7,8,10,13,29], 7 、8组成一颗新的二叉树, 和为`15`

![image-20220719235929546](image/数据结构与算法_韩顺平/image-20220719235929546.png)

上一步处理完后排序[10,13，15,29], 10 、13组成一颗新的二叉树, 和为`23`

![image-20220720001048403](image/数据结构与算法_韩顺平/image-20220720001048403.png)

上一步处理完后排序[15,23,29], 15、23组成一颗新的二叉树, 和为`38`

![image-20220720001211622](image/数据结构与算法_韩顺平/image-20220720001211622.png)

上一步处理完后排序[29，38], 29，38组成一颗新的二叉树, 和为`67`

![img](image/数据结构与算法_韩顺平/o_200912012851屏幕截图 2020-09-12 092825.png)
...
![img](image/数据结构与算法_韩顺平/o_200912015418图片1-1670135040096-47.png)
...
![image-20201213093040271](image/数据结构与算法_韩顺平/image-20201213093040271.e007f859-1670135040096-48.png)

下面是每次生成新的二叉树总是排在权值相同的二叉树的最后一个，则生成二叉树为：

![image-20201213095733801](image/数据结构与算法_韩顺平/image-20201213095733801.0e923fd5-1670135040096-49.png)
...
![image-20201214221333991](image/数据结构与算法_韩顺平/image-20201214221333991.3c1471de.png)
...
1. 目标节点是 **叶子节点**
   ...
   ![image-20201216231821371](image/数据结构与算法_韩顺平/image-20201216231821371.0cae25c0.png)
...
2. 目标节点有 **一颗子节点** left 或则 right，那么就需要将目标节点的子节点提升到目标节点位置上 [比如 1]
   ...
   ![image-20201216231850849](image/数据结构与算法_韩顺平/image-20201216231850849.c6a35866.png)
...
1. 目标节点有 **两颗子节点**
   ...
   ![image-20201216231906429](image/数据结构与算法_韩顺平/image-20201216231906429.eb08c53a.png)
...
![img](image/数据结构与算法_韩顺平/o_200912023903图片3.png)
...
![image-20201220171853831](image/数据结构与算法_韩顺平/image-20201220171853831.2a28f89d.png)
...
![img](image/数据结构与算法_韩顺平/o_200912024758左旋转-1670135040096-50.gif)
...
![img](image/数据结构与算法_韩顺平/o_200912024719左旋转分析图.png)

插入 8 时，发现左右子树高度相差大于 1，则进行左旋转：

1. 创建一个新的节点 `newNode`，值等于当前 **根节点** 的值（以 4 创建）

   <img src="image/数据结构与算法_韩顺平/image-20220730230620175.png" alt="image-20220730230620175"  />
...
2. 把新节点的 **左子树** 设置为当前节点的 **左子树**
   ...
   ![image-20220730230845089](image/数据结构与算法_韩顺平/image-20220730230845089.png)
...
3. 把新节点的 **右子树** 设置为当前节点的 **右子树的左子树**
   ...
   ![image-20220730230924833](image/数据结构与算法_韩顺平/image-20220730230924833.png)
...
4. 把 **当前节点** 的值换为 **右子节点** 的值
   ...
   ![image-20220730231010930](image/数据结构与算法_韩顺平/image-20220730231010930.png)
...
5. 把 **当前节点** 的右子树设置为 **右子树的右子树**
   ...
   ![image-20220730231050811](image/数据结构与算法_韩顺平/image-20220730231050811.png)
...
​	![image-20220730231217191](image/数据结构与算法_韩顺平/image-20220730231217191.png)

注：左图是调整期，右图是调整后。注意调整期的 6 那个节点，**调整之后，没有节点指向他了**。也就是说，遍历的时候它是不可达的。那么将会自动的被垃圾回收掉。

![image-20220730231524240](image/数据结构与算法_韩顺平/image-20220730231524240.png)
...
2. 满足 `右子树高度 - 左子树高度 > 1`，那么一定满足下面的条件：
   ...
   ![image-20201220203654437](image/数据结构与算法_韩顺平/image-20201220203654437.ed835ffd-1670135040096-51.png)
...
![image-20201220203955282](image/数据结构与算法_韩顺平/image-20201220203955282.e86e5c40-1670135040096-52.png)
...
![img](image/数据结构与算法_韩顺平/o_200912025009右旋转动画-1670135040096-53.gif)
...
![img](image/数据结构与算法_韩顺平/o_200912024928右旋转分析图.png)
...
![img](image/数据结构与算法_韩顺平/o_200912025737问题分析.png)
...
![image-20201221222129296](image/数据结构与算法_韩顺平/image-20201221222129296.134b58be-1670135040097-55.png)
...
![img](image/数据结构与算法_韩顺平/o_200912030029图片4.png)
...
![img](image/数据结构与算法_韩顺平/o_200912030258图片5.png)

### 12.1.3 B 树的基本介绍

B 树通过重新组织节点， 降低树的高度， 并且减少 i/o 读写次数来提升效率。

![img](image/数据结构与算法_韩顺平/o_200912030357图片6.png)
...
![img](image/数据结构与算法_韩顺平/o_200912032155图片1.png)
...
1. 添加 16、24
   ...
   ![image-20201222215622985](image/数据结构与算法_韩顺平/image-20201222215622985.png)
...
2. 添加 12
   ...
   ![image-20201222220054922](image/数据结构与算法_韩顺平/image-20201222220054922.4bb0c572.png)
...
3. 添加 32
   ...
   ![image-20201222220658607](image/数据结构与算法_韩顺平/image-20201222220658607.7e19b48d.png)

4. 添加 14

   这个也简单，直接添加到 12 的右边，变成 `12,14`

   ![image-20201222220819603](image/数据结构与算法_韩顺平/image-20201222220819603.47306946.png)

5. 添加 26

   此时应该添加到 `24,32` 的中间，由于一个节点只能添加两个数据，那么就需要拆分。

   ![image-20201222221007671](image/数据结构与算法_韩顺平/image-20201222221007671.4cd4fac3.png)
...
6. 添加 34
   ...
   ![image-20201222221737672](image/数据结构与算法_韩顺平/image-20201222221737672.96aa55f1.png)
...
7. 添加 10
   ...
   ![image-20201222222211562](image/数据结构与算法_韩顺平/image-20201222222211562.e35fc788.png)
...
8. 添加 8
   ...
   ![image-20201222223140613](image/数据结构与算法_韩顺平/image-20201222223140613.44b569bb.png)

9. 添加 28

   ![image-20201222223425500](image/数据结构与算法_韩顺平/image-20201222223425500.4f29c845.png)
...
![image-20201222223829797](image/数据结构与算法_韩顺平/image-20201222223829797.1834a017.png)

1. 添加 20

   这个也简单，直接组成 `20,24`

   ![image-20201222223916961](image/数据结构与算法_韩顺平/image-20201222223916961.448151e2.png)
...
![img](image/数据结构与算法_韩顺平/o_200912032231图片7.png)
...
![img](image/数据结构与算法_韩顺平/o_200912032333图片8-1670135040097-54.png)
...
![img](image/数据结构与算法_韩顺平/o_200912032532图片9-1670135040097-56.png)
...
![img](image/数据结构与算法_韩顺平/o_200912032757图片10-1670135040097-57.png)
...
![image-20210101151050990](image/数据结构与算法_韩顺平/image-20210101151050990.52bd2bd3.png)

**图是一种数据结构**， 其中结点可以具有零个或多个相邻元素。 两个结点之间的连接称为**边**。 结点也可以称为**顶点**。

### 13.1.3 图的常用概念

![image-20210101151445645](image/数据结构与算法_韩顺平/image-20210101151445645.b111931f.png)
...
- 无向图：**顶点之间的连接没有方向**
  ...
  ![image-20220731223450860](image/数据结构与算法_韩顺平/image-20220731223450860.png)

  比如上图它是一个 **无向图**；比如 `A-B`，可以是 `A->B` 也可以是 `B <- A`

- 有向图：顶点之间的连接是有方向的。如下图

  ![image-20220731222531302](image/数据结构与算法_韩顺平/image-20220731222531302-1670135040097-58.png)

  那么 `A-B`，就只能是 `A → B`，而不能是 `B → A`

- 带权图：边有权值时，则叫做带权图，同时也叫 **网**

  ![image-20210101152209177](image/数据结构与算法_韩顺平/image-20210101152209177.0ae3fbdc.png)
...
![img](image/数据结构与算法_韩顺平/o_200913005709屏幕截图 2020-09-13 085501.png)
...
![img](image/数据结构与算法_韩顺平/o_200913005714屏幕截图 2020-09-13 085621.png)
...
![image-20210101154657256](image/数据结构与算法_韩顺平/image-20210101154657256.e47f87b1.png)
...
![image-20210101173349039](image/数据结构与算法_韩顺平/image-20210101173349039.6492184a.png)



![image-20220803225552781](image/数据结构与算法_韩顺平/image-20220803225552781-1670135040097-60.png)
...
![image-20210102141247460](image/数据结构与算法_韩顺平/image-20210102141247460.c140af98-1670135040097-59.png)
...
![image-20220803225756127](image/数据结构与算法_韩顺平/image-20220803225756127-1670135040097-61.png)
...
![img](image/数据结构与算法_韩顺平/o_200913012335图片11.png)
...
![汉诺塔1](image/数据结构与算法_韩顺平/汉诺塔1.gif)

![汉诺塔2](image/数据结构与算法_韩顺平/汉诺塔2.gif)

![汉诺塔3](image/数据结构与算法_韩顺平/汉诺塔3.gif)
...
2. 当有 `n ≥ 2` 的情况，我们总是可以看做是两个盘：
   ...
   ![image-20210102224320581](image/数据结构与算法_韩顺平/image-20210102224320581.a7812e0c.png)
...
1. `v[i][0] = v[0][j]=0`
   ...
   ![image-20210103123733067](image/数据结构与算法_韩顺平/image-20210103123733067.ca318d67.png)
...
3. 当 `j ≥ w[i]` 时：`v[i][j] = max{v[i - 1][j],v[i - 1][j - w[i]] + v[i]}`
   ...
   ![image-20210103124813651](image/数据结构与算法_韩顺平/image-20210103124813651.827c4b5f.png)
...
1. 都用第 1 个字符进行比较，不符合，关键词（文本串）向后移动一位
   ...
   ![image-20210103214314948](image/数据结构与算法_韩顺平/image-20210103214314948.57bca6e9.png)

2. 重复第一步，还是不符合，再后移动

   ![image-20210103214344856](image/数据结构与算法_韩顺平/image-20210103214344856.616b9ff4.png)

3. 一直重复，直到 str1 有一个字符与 str2 的第一个字符匹配为止

   ![image-20210103214429270](image/数据结构与算法_韩顺平/image-20210103214429270.71cb0b69.png)

4. 接着比较字符串和搜索词的下一个字符，还是符合

   ![image-20210103214507570](image/数据结构与算法_韩顺平/image-20210103214507570.c7aa65fa.png)

5. 遇到 st1 有一个字符与 str2 对应的字符不符合时

   ![image-20210103214551781](image/数据结构与算法_韩顺平/image-20210103214551781.c92cf601.png)

6. 这时候：想到的是继续遍历 st1 的下一个字符（也就是暴力匹配）

   ![image-20210103214636453](image/数据结构与算法_韩顺平/image-20210103214636453.98b47f20.png)

   这时，就出现一个问题：

   ![image-20210103214808419](image/数据结构与算法_韩顺平/image-20210103214808419.e8e4378c.png)
...
7. KMP 利用 **部分匹配表**，来省略掉刚刚重复的步骤。
   ...
   ![image-20210103215655806](image/数据结构与算法_韩顺平/image-20210103215655806.02bd6ae8.png)
...
9. 前面得到部分模式串的值为2，直接从第三位开始匹配，因为空格与 C 不匹配
   ...
   ![image-20210103220912929](image/数据结构与算法_韩顺平/image-20210103220912929.4da32422.png)

   搜索词还要继续往后移动，这时，已匹配的字符树数为 2 （`AB`），对应的 **部分匹配值** 为 0，所以 `移动位数 = 2 - 0 = 2`，于是将搜索词（文本串）向后移动两位

   ![image-20210103221319413](image/数据结构与算法_韩顺平/image-20210103221319413.7a26aa89.png)
...
12. 逐位比较，直到搜索词（文本串）的最后一位，发现完全匹配，搜索完成。
    ...
    ![image-20210103221650411](image/数据结构与算法_韩顺平/image-20210103221650411.83f71473.png)
...
![image-20210103222000752](image/数据结构与算法_韩顺平/image-20210103222000752.7c53f913.png)
...
![img](image/数据结构与算法_韩顺平/o_200913022818图片12.png)
...
4. 举例说明
   ...
   ![img](image/数据结构与算法_韩顺平/o_200913023035图片13-1670135040097-62.png)
...
![image-20210104140833558](image/数据结构与算法_韩顺平/image-20210104140833558.70890b15.png)
...
![image-20210104144759316](image/数据结构与算法_韩顺平/image-20210104144759316.855b8c32.png)
...
![img](image/数据结构与算法_韩顺平/o_200913023645图片14-1670135040097-65.png)
...
![image-20210105100343828](image/数据结构与算法_韩顺平/image-20210105100343828.0de8f27a.png)

例如，对于如上图 G4 所示的连通网可以有多棵权值总和不相同的生成树。

![image-20210105100437798](image/数据结构与算法_韩顺平/image-20210105100437798.2eca0c17.png)

有多种不同的连通方式，但是哪一种权值才是最优的呢？下面是克鲁斯卡尔算法的图解步骤：

以上图 G4 为例，来对克鲁斯卡尔进行演示(假设，用数组 R 保存最小生成树结果)。

![image-20210105100618462](image/数据结构与算法_韩顺平/image-20210105100618462.6d9ac0e3-1670135040097-63.png)
...
![img](image/数据结构与算法_韩顺平/o_200913024131222-1670135040097-64.png)
...
1. `E,F -> 4,5` 由于 终点列表中没有，那么第一条边的 **起点 E 的终点就是 F**
   ...
   ![image-20210105135521375](image/数据结构与算法_韩顺平/image-20210105135521375.681fb39d-1670135040097-66.png)

2. `C,D -> 2,3`

   ![image-20210105135627931](image/数据结构与算法_韩顺平/image-20210105135627931.3ba7de7a-1670135040097-69.png)
...
3. `D,E -> 3,4`
   ...
   ![image-20210105140059987](image/数据结构与算法_韩顺平/image-20210105140059987.bb6542de-1670135040097-67.png)
...
4. 最终选择完后的终点列表中的数据为
   ...
   ![image-20210105140826290](image/数据结构与算法_韩顺平/image-20210105140826290.dbc6fdd7-1670135040097-68.png)
...
<img src="image/数据结构与算法_韩顺平/image-20210105181340256.2593f8ad-1670135040097-70.png" alt="image-20210105181340256" style="zoom:50%;" />
...
3. 根据广度优先原则（并不是以 GA，GB A 在前面而选择 A，这里的广度优先指的是：以 G 为起点，那么则把与 G 直连的全部计算，这样一层一层的计算），会先判定 A 点是否需要作为 **访问顶点（注意不是出发顶点）**，需要满足以下条件：
   ...
   2. 并且 G 点到 A 点的距离，要小于 dis_arr 中对应 G 到 A 的距离，因为可能出现以下情况：
      ...
      ![image-20210105202655674](image/数据结构与算法_韩顺平/image-20210105202655674.9f5e5c95-1670135040097-71.png)
   ...
   ![image-20210105181340256](image/数据结构与算法_韩顺平/image-20210105181340256.2593f8ad-16621035798055-1670135040097-72.png)
...
![image-20210110171534255](image/数据结构与算法_韩顺平/image-20210110171534255.e479a789-1670135040097-73.png)
...
![image-20210110171628121](image/数据结构与算法_韩顺平/image-20210110171628121.d4b42ca9-1670135040097-74.png)
...
- 第一轮循环中，以 A (下标为：0) 作为 **中间顶点**，距离表和前驱关系更新为：
  ...
  ![image-20210110172409026](image/数据结构与算法_韩顺平/image-20210110172409026.7c57dece-1670135040094-2.png)
  ...
  2. 更新距离表，需要与上一次的距离表作为参照对比
     ...
     ![image-20210110171534255](image/数据结构与算法_韩顺平/image-20210110171534255.e479a789-1670135040081-1.png)
...
![image-20210111001913357](image/数据结构与算法_韩顺平/image-20210111001913357.9cd7ae7b-1670135040097-75.png)
